...
# how to get this token will be in the start of the video maybe    
client.run('put token here')

# yea now its fixed the link fo the code will be in the comments 
